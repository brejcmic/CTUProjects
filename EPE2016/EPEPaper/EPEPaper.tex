...
\begin{abstract}
%\boldmath
The paper discusses a way to deploy luminaires in a model room to provide required illuminance levels and uniformity of the working plane by using a genetic algorithm. A horizontal grid of possible luminaire locations has been established and symmetry introduced to get more practical luminaire placement.
