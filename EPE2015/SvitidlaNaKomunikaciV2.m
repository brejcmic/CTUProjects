...
for generace = 1:1:pop.gen
    ...
    for i= 1:1:pop.N
        ...
        E.ys = (kom.yOffset - kom.yPata + pop.dna.DY(i))*ones(1,floor(E.Ns/2)+1);
        E.ys = [E.ys, (kom.yOffset + kom.yPata + kom.sirka - pop.dna.DY(i))*ones(1,ceil(E.Ns/2))];
...
%    pop.Eavg = sum(pop.E,2)/ kom.Nx/ kom.Ny;
    ...
    E.ys = (kom.yOffset - kom.yPata + pop.dna.DY(IDX))*ones(1,floor(E.Ns/2)+1);
    E.ys = [E.ys, (kom.yOffset + kom.yPata + kom.sirka - pop.dna.DY(IDX))*ones(1,ceil(E.Ns/2))];
