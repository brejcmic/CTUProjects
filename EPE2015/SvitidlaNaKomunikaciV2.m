...
for generace = 1:1:pop.gen
    ...
    for i= 1:1:pop.N
        ...
        E.xs = (kom.delka - E.Ns * pop.dna.DX(i))/2 + (0:2:2*floor(E.Ns/2))*pop.dna.DX(i);
        E.xs = [E.xs, (kom.delka - E.Ns * pop.dna.DX(i))/2 + (1:2:2*floor((E.Ns-1)/2)+1)*pop.dna.DX(i)];
        E.ys = (kom.yOffset + pop.dna.DY(i))*ones(1,floor(E.Ns/2)+1);
        E.ys = [E.ys, (kom.yOffset + kom.sirka - pop.dna.DY(i))*ones(1,ceil(E.Ns/2))];
        %souradnice svitidel se opakuji ve sloupcich matice
        E.mat.xs = E.xs' * ones(1, kom.Nx*kom.Ny);
        E.mat.ys = E.ys' * ones(1, kom.Nx*kom.Ny);
        ...
        E.mat.sinB = E.mat.sinB .* [ones(floor(E.Ns/2)+1, kom.Nx*kom.Ny); -1*ones(ceil(E.Ns/2), kom.Nx*kom.Ny)]; %na druhe strane ulice jsou zaporne uhly
        E.mat.sinBeta = (E.mat.xs - E.mat.xb)./ E.mat.l; %Tady je to obracene
        E.mat.sinBeta = E.mat.sinBeta .* [ones(floor(E.Ns/2)+1, kom.Nx*kom.Ny); -1*ones(ceil(E.Ns/2), kom.Nx*kom.Ny)]; %na druhe strane ulice jsou zaporne uhly
        ...
        E.mat.ys = E.ys' * ones(1, kom.Nx*kom.NyMimo);
        ...
        E.mat.l = ((E.mat.xs-E.mat.xb).^2 + (E.mat.ys-E.mat.yb).^2 + E.mat.zs.^2).^0.5 +eps;
        E.mat.sinB = (E.mat.yb - E.mat.ys)./ E.mat.l;
        E.mat.sinB = E.mat.sinB .* [ones(floor(E.Ns/2)+1, kom.Nx*kom.NyMimo); -1*ones(ceil(E.Ns/2), kom.Nx*kom.NyMimo)]; %na druhe strane ulice jsou zaporne uhly
        E.mat.sinBeta = (E.mat.xs - E.mat.xb)./ E.mat.l; %Tady je to obracene
        E.mat.sinBeta = E.mat.sinBeta .* [ones(floor(E.Ns/2)+1, kom.Nx*kom.NyMimo); -1*ones(ceil(E.Ns/2), kom.Nx*kom.NyMimo)]; %na druhe strane ulice jsou zaporne uhly
        %odklon paprsku plosky od normaly bodu dopadu je Theta
        E.mat.cosTheta = E.mat.zs./ E.mat.l;
    ...
    E.xs = (kom.delka - E.Ns * pop.dna.DX(IDX))/2 + (0:2:2*floor(E.Ns/2))*pop.dna.DX(IDX);
    E.xs = [E.xs, (kom.delka - E.Ns * pop.dna.DX(IDX))/2 + (1:2:2*floor((E.Ns-1)/2)+1)*pop.dna.DX(IDX)];
    E.ys = (kom.yOffset + pop.dna.DY(IDX))*ones(1,floor(E.Ns/2)+1);
    E.ys = [E.ys, (kom.yOffset + kom.sirka - pop.dna.DY(IDX))*ones(1,ceil(E.Ns/2))];
