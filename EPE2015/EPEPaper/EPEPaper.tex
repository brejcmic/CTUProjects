...
\fancyhf{}
\fancyfoot[L]{978-1-4673-6788-2/15/\$31.00 (C)2015 IEEE}
...
\textbf{\textit{Keywords - genetic, algorithm, lighting, design, iluminance}}
\thispagestyle{fancy}
...
Even the algorithm found the solutions in only 60\break \newpage \noindent generations, the calculation last approximately 10~minutes. The reason was lot of calculated points ($8000+6000$) and relatively large population (200) in each generation. The standards recommend much thinner points concentrations and they do not deal with lighting out of the sidewalk. The algorithm lasted only 2~minutes in case of recommended count of points.
...
The authors would like to thank for support from the student grant SGS13/197/OHK3/3T/13 of the Czech Technical University in Prague.
