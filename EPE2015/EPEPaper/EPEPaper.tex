...
\title{Public lightening evaluation by using of genetic algorithm}
...
\author{\IEEEauthorblockN{Rudolf Bayer}
\IEEEauthorblockA{CTU in Prague\\Faculty of Electrical Engineering\\
...
\and
\IEEEauthorblockN{Jan Zálešák}
\IEEEauthorblockA{CTU in Prague\\Faculty of Electrical Engineering\\
Department of Electrical Power Engineering\\
Praha 6, Technická 2, 166 27\\
Email: zalesja1@fel.cvut.cz}}
\selectlanguage{english}
...
%VIALOX NAV-T SUPER 6Y. OSRAM GMBH. \emph{Osram} [online]. 2015 [cit. 2015-02-18]. Available at: 
%http://www.osram.com/osram_com/products/lamps/high-intensity-discharge-lamps/high-pressure-sodium-vapor-lamps-for-open-and-enclosed-luminaires/vialox-nav-t-super-6y/index.jsp
